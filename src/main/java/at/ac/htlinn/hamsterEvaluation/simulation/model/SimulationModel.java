...
import at.ac.htlinn.hamsterEvaluation.lego.model.KornDaException;
import at.ac.htlinn.hamsterEvaluation.lego.model.MaulNichtLeerException;
...
import at.ac.htlinn.hamsterEvaluation.model.TerminalInstruction;
import at.ac.htlinn.hamsterEvaluation.model.TerrainCellInstruction;
import at.ac.htlinn.hamsterEvaluation.model.TerrainInstruction;
...
public class SimulationModel extends Observable implements InstructionProcessor {
	...
	public void reset() {
		...
		notifyObservers(TERRAIN);
		savedTerrain = null;
		// at.ac.htlinn.hamsterEvaluation.workbench.Workbench.getWorkbench().getSimulation()
