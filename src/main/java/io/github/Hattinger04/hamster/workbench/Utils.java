...
public class Utils {
	...
	public static int COLOR = io.github.Hattinger04.hamster.debugger.model.Hamster.BLUE;
			...
			if (file != null && file.exists() && file.isFile()
				...
				if (str != null)
					if (str.toUpperCase().equals("BLAU")
						...
						Utils.COLOR = io.github.Hattinger04.hamster.debugger.model.Hamster.BLUE;
					} else if (str.toUpperCase().equals("ROT")
							|| str.toUpperCase().equals("RED")) {
						Utils.COLOR = io.github.Hattinger04.hamster.debugger.model.Hamster.RED;
					} else if (str.toUpperCase().equals("GRUEN")
							|| str.toUpperCase().equals("GREEN")) {
						Utils.COLOR = io.github.Hattinger04.hamster.debugger.model.Hamster.GREEN;
					} else if (str.toUpperCase().equals("GELB")
							|| str.toUpperCase().equals("YELLOW")) {
						Utils.COLOR = io.github.Hattinger04.hamster.debugger.model.Hamster.YELLOW;
					} else if (str.toUpperCase().equals("CYAN")) {
						Utils.COLOR = io.github.Hattinger04.hamster.debugger.model.Hamster.CYAN;
					} else if (str.toUpperCase().equals("MAGENTA")) {
						Utils.COLOR = io.github.Hattinger04.hamster.debugger.model.Hamster.MAGENTA;
					} else if (str.toUpperCase().equals("ORANGE")) {
						Utils.COLOR = io.github.Hattinger04.hamster.debugger.model.Hamster.ORANGE;
					} else if (str.toUpperCase().equals("PINK")) {
						Utils.COLOR = io.github.Hattinger04.hamster.debugger.model.Hamster.PINK;
					} else if (str.toUpperCase().equals("GRAU")
							|| str.toUpperCase().equals("GRAY")) {
						Utils.COLOR = io.github.Hattinger04.hamster.debugger.model.Hamster.GRAY;
					} else if (str.toUpperCase().equals("WEISS")
							|| str.toUpperCase().equals("WHITE")) {
						Utils.COLOR = io.github.Hattinger04.hamster.debugger.model.Hamster.WHITE;
					}
				io.github.Hattinger04.hamster.debugger.model.Hamster.$i$defColor = Utils.COLOR;
			}
		} catch (Exception exc) {
		}
