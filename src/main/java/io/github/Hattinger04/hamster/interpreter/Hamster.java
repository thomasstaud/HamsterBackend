...
public class Hamster {
	...
	public void init(int reihe, int spalte, int blickrichtung, int anzahlKoerner)
		...
		} catch (io.github.Hattinger04.hamster.model.HamsterNichtInitialisiertException exc) {
	...
	public void vor() throws HamsterNichtInitialisiertException, MauerDaException {
		...
		} catch (io.github.Hattinger04.hamster.model.MauerDaException exc) {
	...
	public void gib() throws HamsterNichtInitialisiertException, MaulLeerException {
		try {
			...
			throw new HamsterNichtInitialisiertException(this);
		} catch (io.github.Hattinger04.hamster.model.MaulLeerException exc) {
	...
	public void nimm() throws HamsterNichtInitialisiertException, KachelLeerException {
		try {
			...
			throw new HamsterNichtInitialisiertException(this);
		} catch (io.github.Hattinger04.hamster.model.KachelLeerException exc) {
	...
	public int getReihe() throws HamsterNichtInitialisiertException {
		try {
			checkInit("getReihe()");
			io.github.Hattinger04.hamster.simulation.model.Hamster h = Workbench.getWorkbench().getSimulationController()
	...
	// } else {
	// io.github.Hattinger04.hamster.simulation.model.Hamster hThis = _intern_simulationModel
	// .getHamster(this._intern_id);
	// io.github.Hattinger04.hamster.simulation.model.Hamster hOther = _intern_simulationModel
	...
	public String toString() {
		...
		if (!this._intern_init) {
			...
			int a = 0;
			String b = "";
			io.github.Hattinger04.hamster.simulation.model.Hamster hThis = Workbench.getWorkbench().getSimulationController()
					.getSimulationModel().getHamster(this._intern_id);
			switch (hThis.getDir()) {
			case NORD:
				b = "NORD";
